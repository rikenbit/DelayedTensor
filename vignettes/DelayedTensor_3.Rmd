...
and used for the visualization and the down-stream analysis.
Core tensor means the intensity of the patterns
and used to decide which patterns are informative.
...
MPCA is a kind of Tucker decompotition and when the order of tensor is 3,
...
out_pvd <- pvd(darr, uranks=rep(2,5), wranks=rep(3,5), a=2, b=3)
str(out_pvd)
```
